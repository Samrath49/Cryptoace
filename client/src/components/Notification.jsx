...
const Notification = ({ props }) => {
  ...
  const errorNotification = (error) => {
    return (
      <>
        <section className="absolute right-10 top-28 m-4">
          <div
      ...
      {view && (
        <section className="absolute right-10 top-28">
          <div
            id="toast-notification"
            className="relative flex items-center w-full max-w-xs p-5
              backdrop-blur-sm  bg-slate-900/80 
              text-slate-300 bg-slate-900  border-2 border-slate-600 rounded-lg shadow-xl"
            role="alert"
          >
